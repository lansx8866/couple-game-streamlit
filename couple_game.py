...
questions_db = [
    ...
    },
    {
        ...
        "options": ["乐观", "幽默", "体贴", "细心", "浪漫", "真诚", "温柔", "主动低头", "有主见", "会哄人"，],
        "type": "multi"
    },
    {
        "id": 3,
        ...
        "options": ["漂亮", "有主见", "善解人意", "可爱", "勤奋", "开朗", "稳重", "搞笑", "慷慨", "包容"],
        "type": "multi"
    },
    # 缺点 (multi)
    {
        ...
        "category": "缺点",
        "question": "选择对方的三个缺点",
        "options": ["拖延", "粗心", "脾气急", "固执", "不会哄人", "花钱大手大脚", "不爱运动", "熬夜", "邋遢", "挑食"],
        "type": "multi"
    },
    {
        "id": 5,
        ...
        "options": ["邋遢", "不主动沟通", "爱玩游戏", "情绪化", "记仇", "多疑", "嘴硬", "不肯低头", "不浪漫", "粗心"],
        "type": "multi"
    },
    {
        "id": 6,
    ...
    # 一起做的事 (single)
    {
        ...
        "options": ["旅行", "看电影", "做饭（do i）", "散步", "图书馆学习", "打游戏", "逛街", "露营", "看日出", "养宠物"],
        "type": "single"
    },
    {
        "id": 8,
        ...
        "options": ["一起看海", "一起看日出", "漂亮的烛光晚餐", "手牵手散步", "听音乐剧", "去游乐园", "看电影", "泡温泉", "自驾游", "一起做饭"],
        "type": "single"
    },
    {
        "id": 9,
        ...
        "options": ["一起学习", "一起参加派对", "一起做手工", "一起逛博物馆", "一起看演唱会", "一起运动", "一起睡觉", "一起画画", "一起钓鱼", "一起插花"],
        "type": "single"
    },
    # 感动的事 (single)
    {
    ...
    },
    {
        ...
        "options": ["你累了给你按摩", "为你准备早餐", "帮你解决问题", "给你鼓励", "记得你随口说的话", "替你分担忧愁", "给你小惊喜", "照顾你的情绪", "为你着想", "包容你"],
        "type": "single"
    },
    {
        "id": 12,
...
# 奖励和惩罚池（可后端编辑）
rewards = [
    "抱抱10秒", "亲吻10下", "说一句情话", "为对方按摩5分钟",
    "陪对方做一件想做的事", "送一个小礼物", "写一封情书", "为对方唱一首歌"，"奖励一个小甜品"
    "对方用三种语言说'我爱你'","随机拜年红包一个"
]
punishments = [
    "做10个俯卧撑", "学狗叫三声", "挠痒痒五下", "洗衣服",
    "请对方喝奶茶", "背对方走10步", "讲一个笑话", "撒娇十秒钟"
    "跳即兴舞蹈","用屁股写我错了","发语音说我是猪"， "用娃娃音读新闻"
]
